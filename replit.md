...
- July 2, 2025: RECALIBRATED player name, skill level, and target coordinates based on scoresheet reference:
  - Player names now start from exact coordinates: Player 1 at [0,322], Player 2 at [1,465]
  - Removed dynamic width constraints and font sizing for player names
  - Skill levels repositioned to Player # fields: Player 1 at [272,94], Player 2 at [272,152]
  - Target scores moved to Score fields: Player 1 at [631,27], Player 2 at [631,143]
  - Applied coordinate changes to both PDF generation and scoresheet display components
